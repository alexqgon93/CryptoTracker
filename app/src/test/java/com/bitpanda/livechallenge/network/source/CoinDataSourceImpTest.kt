...
class CoinDataSourceImpTest {
    ...
    @Test
    fun `GIVEN successful response WHEN getAssets THEN returns right`() = runTest {
    ...
    @Test
    fun givenFailingAssetApi_whenGetAssets_thenReturnsLeft() = runTest {
    ...
    @Test
    fun givenSuccessfulRatesApi_whenGetRates_thenReturnsRight() = runTest {
    ...
    @Test
    fun givenFailingRatesApi_whenGetRates_thenReturnsLeft() = runTest {
