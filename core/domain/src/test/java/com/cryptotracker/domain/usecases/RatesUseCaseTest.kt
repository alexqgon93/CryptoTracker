...
class RatesUseCaseTest {
    ...
    @Test
    fun `Given NetworkError WHEN call the use case THEN error is received`() =
        runTest {
    ...
    @Test
    fun `Given BadRequest WHEN call the use case THEN error is received`() =
        runTest {
    ...
    @Test
    fun `Given ServerError WHEN call the use case THEN error is received`() =
        runTest {
    ...
    @Test
    fun `Given Unknown WHEN call the use case THEN error is received`() =
        runTest {
    ...
    @Test
    fun `Given Connectivity WHEN call the use case THEN error is received Error`() =
        runTest {
    ...
    @Test
    fun `Given Server WHEN call the use case THEN error is received Error`() =
        runTest {
    ...
    @Test
    fun `Given NoConnection WHEN call the use case THEN error is received Error`() =
        runTest {
            coEvery { repository.getRates() } returns
    ...
    @Test
    fun `GIVEN a success WHEN call the use case THEN call the repository successfully`() =
        runTest {
