package com.cryptotracker.network

import arrow.core.Either
import com.cryptotracker.network.utils.Failure
import com.cryptotracker.network.utils.getErrorBody
import com.cryptotracker.network.utils.safeCall
import com.cryptotracker.network.utils.toError
...
class UtilsTest {
    ...
    @Test
    fun `GIVEN error response WHEN tryCall is called THEN returns Left Failure`() =
        runTest {
