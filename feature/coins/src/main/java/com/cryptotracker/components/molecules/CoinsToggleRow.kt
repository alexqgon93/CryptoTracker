...
import com.cryptotracker.components.atoms.OutlinedToggleButton
...
fun CoinsToggleRow(
    ...
    OutlinedToggleButton(
        ...
        contentDescription = stringResource(id = R.string.top_coins_content_description),
    )
    OutlinedToggleButton(
        modifier =
            modifier
        ...
        contentDescription = stringResource(id = R.string.lowest_coins_content_description),
    )
}
